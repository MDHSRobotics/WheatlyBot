 ...
 * @see RopeSubsystem
 */
public class AUTOPosTwo_LLL extends MDCommand {
	 ...
	 */
	public AUTOPosTwo_LLL(MDRobotBase robot, String name) {
		super(robot, name);
	...
	protected void execute() {
		if (autoSubsystem!=null)autoSubsystem.AUTOPosTwo_LLL();
		log(Level.DEBUG,"execute()","Position 2 LLL");
