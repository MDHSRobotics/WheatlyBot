 ...
 * @see RopeSubsystem
 */
public class AUTOPosThree_LLL extends MDCommand {
	 ...
	 */
	public AUTOPosThree_LLL(MDRobotBase robot, String name) {
		super(robot, name);
	...
	protected void execute() {
		if (autoSubsystem!=null)autoSubsystem.AUTOPosThree_LLL();
		log(Level.DEBUG,"execute()","Position 3 LLL");
		autoSubsystem.AUTOPosThree_LLL();
	}
