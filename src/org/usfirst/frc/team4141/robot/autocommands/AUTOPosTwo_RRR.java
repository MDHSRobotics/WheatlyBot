 ...
 * @see RopeSubsystem
 */
public class AUTOPosTwo_RRR extends MDCommand {
	 ...
	 */
	public AUTOPosTwo_RRR(MDRobotBase robot, String name) {
		super(robot, name);
	...
	protected void execute() {
		if (autoSubsystem!=null)autoSubsystem.AUTOPosTwo_RRR();
		log(Level.DEBUG,"execute()","Position 2 RRR");
		autoSubsystem.AUTOPosTwo_RRR();
	}
