 ...
 * @see RopeSubsystem
 */
public class MaintainCommand extends MDCommand {
	 ...
	 */
	public MaintainCommand(MDRobotBase robot, String name, double duration, double power) {
		super(robot, name);
...
//		log(Level.DEBUG,"execute()","Maintain");
	}
